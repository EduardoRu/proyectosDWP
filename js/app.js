function createModal() {
    ...
    form = '<button type="button" class="btn bg-success text-light border rounded-0" data-bs-toggle="modal" data-bs-target="#exampleModal"> \
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">\
    ...
    // Agregar el modal create

    divModalCreate = document.getElementById('modal_create');

    divModalCreate.innerHTML+= form;
}
